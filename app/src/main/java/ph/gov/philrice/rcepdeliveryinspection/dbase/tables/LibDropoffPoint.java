...
@Entity(tableName = "lib_dropoff_point")
public class LibDropoffPoint {
    ...
    public LibDropoffPoint(int dropoffPointId, String region, String province, String municipality, String dropOffPoint) {
