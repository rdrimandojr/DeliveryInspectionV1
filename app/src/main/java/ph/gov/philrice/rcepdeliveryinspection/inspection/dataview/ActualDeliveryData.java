...
public class ActualDeliveryData {
    ...
    public ActualDeliveryData(String batchTicketNumber, String seedVariety, int totalBagCount,
                              String dateCreated, int send, String seedTag, String prv_dropoff_id,
                              String prv, String moa_number, String app_version, String batchSeries,
                              int sendLocal, int sendCentral, String remarks, int isRejected,
                              int isDownloaded, int hasRLA, String sack_code, int misBuffer,
                              String QRValStart, String QRValEnd,
