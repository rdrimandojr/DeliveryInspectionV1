...
@Entity(tableName = "tmp_delivery_batch_data")
public class TmpDeliveryBatchData {
    ...
    public TmpDeliveryBatchData(String ticketNumber, String batchTicketNumber,
                                String deliveryDate, String coopAccreditation, String seedTag,
                                String seedVariety, String seedClass, int totalBagCount, int userId,
    ...
    /*    public TmpDeliveryBatchData(String ticketNumber, String batchTicketNumber, String deliveryDate,
